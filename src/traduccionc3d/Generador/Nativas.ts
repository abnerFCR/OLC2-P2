...
export class Nativas {
    constructor() {
        ...
        this.nativa_length();
        this.nativa_to_lowerCase();
        this.nativa_to_upperCase();
        this.nativa_char_at();
    }
    ...
    public nativa_to_upperCase() {
        let generador = Generador.getInstancia();
        generador.addComentario("-----INICIA TO UPPERCASE-----");
        generador.addBegin("nativa_to_upperCase()", "void");
        ...
        let etiqSal = generador.newEtiqueta();
        let etiqIns = generador.newEtiqueta();
        let etiqNo = generador.newEtiqueta();
        generador.addEtiqueta(etiqEnt);                     //Le:
        let temp2 = generador.newTemporal();
        generador.liberarTemporal(temp2);
        generador.addGetHeap(temp2, temp1);                 // t2 = heap[t1]
        generador.addIf(temp2, -1, '!=', etiqIns);          //  if(t2!=-1) goto Li
        generador.addGoto(etiqSal);                         //  goto Ls
        generador.addEtiqueta(etiqIns);
        //Li:
        generador.addIf(temp2, 122, '>', etiqNo);              //  if(t2 > 122) goto Ln
        generador.addIf(temp2, 97, '<', etiqNo);               //  if(t2 < 97) goto Ln
        generador.addExpresion(temp2, temp2, 32, '-');      //  t2 = t2 - 32
        generador.addEtiqueta(etiqNo);                      //Ln:
        generador.addSetHeap('h', temp2);                   //  heap[h]=t2
        generador.nextHeap();                               //  h = h+1
        generador.addExpresion(temp1, temp1, 1, '+');       //  t1 = t1 + 1
        generador.addGoto(etiqEnt)                          //  goto Le
        ...
        generador.addReturnVoid();
        generador.addEnd();
        generador.addComentario("-----FIN TO UPPERCASE-----");
    }
    public nativa_to_lowerCase() {
        let generador = Generador.getInstancia();
        generador.addComentario("-----INICIA TO LOWERCASE-----");
        generador.addBegin("nativa_to_lowerCase()", "void");
        ...
        generador.addIf(temp2, 90, '>', etiqNo);           //   if(t2 > 90) goto Ln
        generador.addIf(temp2, 65, '<', etiqNo);            //  if(t2 < 65) goto Ln
        generador.addExpresion(temp2, temp2, 32, '+');      //  t2 = t2 - 32
        generador.addEtiqueta(etiqNo);                      //Ln:
        generador.addSetHeap('h', temp2);                   //  heap[h]=t2
        generador.nextHeap();                               //  h = h+1
        ...
        generador.addReturnVoid();
        generador.addEnd();
        generador.addComentario("-----FIN TO LOWERCASE-----");
    }

    public nativa_length() {
        let generador = Generador.getInstancia();
        generador.addComentario("-----INICIA LENGTH-----");
        generador.addBegin("nativa_length()", "void");
        ...
        let tempR = generador.newTemporal();
        generador.liberarTemporal(tempR);
        generador.addExpresion(contador, 0);
        generador.addExpresion(temp1, 'p', 1, '+');           //t1 = p+1
        generador.addGetStack(temp1, temp1);                 //t1 = stack[t1]
        ...
        generador.addExpresion(contador, contador, 1, '+'); //  tc = tc + 1
        generador.addExpresion(temp1, temp1, 1, '+');       //  t1 = t1 + 1
        generador.addGoto(etiqEnt)                          //  goto Le
        generador.addEtiqueta(etiqSal);                     //Ls:


        generador.addSetStack('p', contador);                     // aca envio la posicion en que iniciara la cadena
        generador.addReturnVoid();
        generador.addEnd();
        generador.addComentario("-----FIN LENGTH-----");
    }

    public nativa_char_at() {
        let generador = Generador.getInstancia();
        generador.addComentario("-----INICIA CHAR AT-----");
        generador.addBegin("nativa_charAt()", "void");
        ...
        let indice = generador.newTemporal();
        ...
        generador.addExpresion(indice, 'p', 2, '+');           //ti = p+1
        generador.addGetStack(indice, indice);                 //ti = stack[ti]
        ...
        generador.addIf(contador, indice, '==', etiqSal);   //  if(tc == ti) goto Ls
        generador.addExpresion(contador, contador, 1, '+'); //  tc = tc + 1
        generador.addExpresion(temp1, temp1, 1, '+');       //  t1 = t1 + 1
        generador.addGoto(etiqEnt)                          //  goto Le
        generador.addEtiqueta(etiqSal);                     //Ls:
        ...
        generador.addSetStack('p', 'h');                     // aca envio la posicion en que iniciara la cadena
        generador.addSetHeap('h',temp2);                     // Heap[h] = t1
        generador.nextHeap();                                // h = h + 1
        ...
        generador.addReturnVoid();
        generador.addEnd();
        generador.addComentario("-----FIN CHAR AT-----");
    }
}
